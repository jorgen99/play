...
bot.locators.xpath.single = function(a, b) {
  var c = function() {
    ...
    return b.selectSingleNode ? (c = goog.dom.getOwnerDocument(b), c.setProperty && c.setProperty("SelectionLanguage", "XPath"), b.selectSingleNode(a)) : null
  }();
...
bot.dom.isSelectable = function(a) {
  ...
  return bot.dom.isElement(a, goog.dom.TagName.INPUT) ? (a = a.type.toLowerCase(), "checkbox" == a || "radio" == a) : !1
};
...
bot.dom.isTextual = function(a) {
  ...
  return bot.dom.isElement(a, goog.dom.TagName.INPUT) ? (a = a.type.toLowerCase(), goog.array.contains(bot.dom.TEXTUAL_INPUT_TYPES_, a)) : bot.dom.isContentEditable(a) ? !0 : !1
};
...
bot.dom.isShown = function(a, b) {
  ...
  return bot.dom.isElement(a, goog.dom.TagName.AREA) ? (e = goog.dom.getAncestor(a, function(a) {
    return bot.dom.isElement(a, goog.dom.TagName.MAP)
  }), !!e && bot.dom.isShown(e, b)) : bot.dom.isElement(a, goog.dom.TagName.INPUT) && "hidden" == a.type.toLowerCase() || bot.dom.isElement(a, goog.dom.TagName.NOSCRIPT) || "hidden" == bot.dom.getEffectiveStyle(a, "visibility") || !c(a) || !b && 0 == bot.dom.getOpacity(a) || !d(a) ? !1 : !0
};
...
goog.dom.TextRange.prototype.containsRange = function(a, b) {
  ...
  return c == goog.dom.RangeType.CONTROL ? (c = a.getElements(), (b ? goog.array.some : goog.array.every)(c, function(a) {
...
bot.action.mouseOver = function(a, b) {
  bot.action.mouseOverAndReturnMouse_(a, b)
};
bot.action.click = function(a, b) {
  var c = bot.action.mouseOverAndReturnMouse_(a, b);
...
bot.action.drag = function(a, b, c, d) {
  var e = bot.action.mouseOverAndReturnMouse_(a, d);
...
bot.action.mouseOverAndReturnMouse_ = function(a, b) {
  bot.action.checkShown_(a);
  var c = goog.dom.getOwnerDocument(a);
...
core.events.replaceText_ = function(a, b) {
  ...
  null != c && (c = parseInt(c), b.length > c && (d = b.substr(0, c)));
  bot.dom.isElement(a, goog.dom.TagName.BODY) ? a.ownerDocument && a.ownerDocument.designMode && "on" == (new String(a.ownerDocument.designMode)).toLowerCase() && (a.innerHTML = d) : goog.userAgent.GECKO && bot.userAgent.isEngineVersion(8) ? XPCNativeWrapper(a).value = d : a.value = d;
  try {
...
core.inject.addElementIdPrefix_ = function(a) {
  ...
  return a && goog.isObject(a) && !goog.isFunction(a) ? goog.object.containsKey(a, bot.inject.ELEMENT_KEY) ? (a[bot.inject.ELEMENT_KEY] = core.inject.ELEMENT_ID_PREFIX + a[bot.inject.ELEMENT_KEY], a) : goog.object.map(a, core.inject.addElementIdPrefix_) : a
};
core.script = {};
core.script.execute = function(a) {
  ...
  return{terminationCondition:function() {
    b && (this.result = c, this.failed = d, this.failureMessage = e);
    return b
  }}
};
core.element = {};
...
core.text.getText = function(a) {
  ...
  goog.userAgent.GECKO && "1.8" <= goog.userAgent.VERSION || goog.userAgent.KONQUEROR || goog.userAgent.SAFARI || goog.userAgent.OPERA ? b = core.text.getTextContent_(a) : a.textContent ? b = a.textContent : a.innerText && (b = a.innerText);
